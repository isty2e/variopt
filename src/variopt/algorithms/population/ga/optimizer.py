...
class GeneticAlgorithmOptimizer(FrozenGenericSlotsCompat,
    ...
    def _build_next_population(
        ...
        *,
        ...
        elite_members = sort_generational_ga_population(parents)[:elite_count]
        offspring_members = sort_generational_ga_population(offspring)[
            : self.population_size - elite_count
        ]
        return GenerationalGAGenerationCommit(
            population=sort_generational_ga_population(
                elite_members + offspring_members,
            ),
        )
