...
from .state import SpeciesGAOptimizerState, SpeciesGAPopulationMember
...
class SpeciesConservingGeneticAlgorithmOptimizer(FrozenGenericSlotsCompat,
    RunMethod[
        SpeciesGAOptimizerState[CandidateT],
        Proposal[CandidateT],
    ...
    @override
    def create_initial_state(self) -> SpeciesGAOptimizerState[CandidateT]:
        ...
        """
        return SpeciesGAOptimizerState(
    ...
    @override
    def is_exhausted(self, state: SpeciesGAOptimizerState[CandidateT]) -> bool:
        """Report whether the optimizer can emit more proposals.

        Parameters
        ----------
        state : SpeciesGAOptimizerState[CandidateT]
    ...
    def ask(
        ...
        state: SpeciesGAOptimizerState[CandidateT],
        batch_size: int = 1,
    ) -> tuple[tuple[Proposal[CandidateT], ...], SpeciesGAOptimizerState[CandidateT]]:
        ...
        *,
        ...
        proposals = tuple(
            Proposal(
                ...
                proposal_id=f"species-ga-{state.proposal_index + offset}",
            )
    ...
    def _build_next_population(
        self,
        *,
        parents: tuple[SpeciesGAPopulationMember[CandidateT], ...],
    ...
    def _sort_population(
        members: tuple[SpeciesGAPopulationMember[CandidateT], ...],
    ) -> tuple[SpeciesGAPopulationMember[CandidateT], ...]:
        return tuple(
            sorted(
                members,
